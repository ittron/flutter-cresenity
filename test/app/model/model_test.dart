...
void main() async {
  ...
  test('BrokenModel', () {
    ...
    ResponseModel<CollectionDataModel> responseModel =
  ...
  test('ResponseListModel', () {
    ...
    ResponseListModel<PostModel> responseModel =
        ResponseListModel<PostModel>.fromJson(json);
  ...
  test('PaginationDataModel', () {
    ...
    ResponseModel<PaginationDataModel<PostModel>> responseModel =
        ResponseModel<PaginationDataModel<PostModel>>.fromJson(json, (map) {
